	    ...
	    { 
		 try{
	        ...
	        //Terminar.setEnabled(true);
			 Toast.makeText(getApplicationContext(), "Gravação iniciada!",
		    	      Toast.LENGTH_LONG).show();
		 }
		 catch(IllegalStateException e){ }
		 Toast.makeText(getApplicationContext(), "Erro ao iniciar gravação!", Toast.LENGTH_LONG).show();
	    }	
	    ...
	    { 
	        ...
	        //Terminar.setClickable(false);
		      Toast.makeText(getApplicationContext(), "Gravação concluída!",
		 		...
		 		Toast.makeText(getApplicationContext(), "Erro ao terminar gravação!",
			    	      Toast.LENGTH_LONG).show();
		 	}
		 	}
